...
if __name__ == "__main__":
    ...
    parser.add_argument('--direction', type=str, default=False, help="x, y, theata or all")
    ...
    bag_directory = parent_dir + "/sensor_test/test_bags"
    recording_name = "Sensor"+str(sensor)+direction
