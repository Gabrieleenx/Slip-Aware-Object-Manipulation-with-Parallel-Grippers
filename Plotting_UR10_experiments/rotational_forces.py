...
if __name__ == "__main__":
    ...
    path_case = parent_dir + "/UR_experiments/bags/case_rotation_t5_60_1.bag"
    path_plastic = parent_dir "/UR_experiments/bags/plastic_rotation_t5_60_1.bag"


    timestamps_traj, data_traj = read_rosbag_trajectory_data(path_case)
    time0 = timestamps_traj[0]-1
    timestamps_traj -= time0
    timestamps, data = read_rosbag_theta_data(path_case)
    timestamps -= time0
    ...
    timestamps_plastic, data_plastic = read_rosbag_theta_data(path_plastic)
